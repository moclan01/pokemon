...
$(document).ready(function () {
    ...
    function updateDataPlayer(index) {
        // console.log("Update");
        playerData.score = 0;
        playerData.win = false;
        playerData.currentLevel = arrLevel[index - 1];

        playerData.timeIndex = arrTime[index - 1];
        playerData.shuffle = arrShuffle[index - 1];
        countDownInterval(playerData.timeIndex);
    ...
    function reset() {
        ...
        playerData.timeIndex = 0;
        playerData.shuffle = 0;
